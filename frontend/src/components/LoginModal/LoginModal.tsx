    ...
    try {
      if (isSignup) {
        ...
        const payload = {
          ...
          email: signupEmail,
          password: signupPwd,
          role: role === "officer" ? "admin" : "student", // map roles to backend format
        };
...
>>>>>>> 93028b2 (login/registration forms now send API calls and registration form validates @ucf.edu emails)
